...
import BaseType, { UInt8, FixedChar3, VarChar, VarChar_medium, Bin32 } from "./../../Base";
...
class Proposal extends BaseType {
   ...
   */
  public set VoteCutOffTimestamp(val: Timestamp) {
    this._VoteCutOffTimestamp = val;
    this._VoteCutOffTimestamp.validate();
  }
  public get VoteCutOffTimestamp() : Timestamp {
    // TODO: implement this unsupported scenario
  }
}
