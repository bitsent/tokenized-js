...
import BaseType, { VarChar, UInt8, VarBin_medium, UInt32, FixedChar5, VarBin } from "./../../Base";
...
class StaticContractFormation extends BaseType {
   ...
   */
  public set ContractCode(val: ContractCode) {
    this._ContractCode = val;
    this._ContractCode.validate();
  }
  public get ContractCode() : ContractCode {
   ...
   */
  public set EffectiveDate(val: Timestamp) {
    this._EffectiveDate = val;
    this._EffectiveDate.validate();
  }
  public get EffectiveDate() : Timestamp {
    // TODO: implement this unsupported scenario
  }
   ...
   */
  public set PrevRevTxID(val: TxId) {
    this._PrevRevTxID = val;
    this._PrevRevTxID.validate();
  }
  public get PrevRevTxID() : TxId {
    // TODO: implement this unsupported scenario
  }
