...
$packages["main"] = (function() {
	var $pkg = {}, $init, js, funcType, main, _concat_2_strings_;
	js = $packages["github.com/gopherjs/gopherjs/js"];
	funcType = $funcType([$String, $String], [$String], false);
	main = function() {
		$module.exports._concat_2_strings_ = $externalize(_concat_2_strings_, funcType);
	};
	_concat_2_strings_ = function(s1, s2) {
		var s1, s2;
		return s1 + s2;
	};
	$init = function() {
